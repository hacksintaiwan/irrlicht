...
//! constructor
CIrrDeviceX11::CIrrDeviceX11(const SIrrlichtCreationParameters& param)
...
bool CIrrDeviceX11::switchToFullscreen(bool reset)
{
...
bool CIrrDeviceX11::createWindow()
{
#ifdef _IRR_COMPILE_WITH_X11_
#ifdef _DEBUG
...
//! create the driver
void CIrrDeviceX11::createDriver()
{
...
void CIrrDeviceX11::setWindowCaption(const wchar_t* text)
{
#ifdef _IRR_COMPILE_WITH_X11_
	if (CreationParams.DriverType == video::EDT_NULL)
		return;
...
bool CIrrDeviceX11::present(video::IImage* image, void* windowId, core::rect<s32>* srcRect)
{
#ifdef _IRR_COMPILE_WITH_X11_
...
void CIrrDeviceX11::closeDevice()
{
	Close = true;
}
...
bool CIrrDeviceX11::isWindowActive() const
{
...
bool CIrrDeviceX11::isWindowFocused() const
{
...
bool CIrrDeviceX11::isWindowMinimized() const
{
...
video::ECOLOR_FORMAT CIrrDeviceX11::getColorFormat() const
{
#ifdef _IRR_COMPILE_WITH_X11_
...
void CIrrDeviceX11::setResizable(bool resize)
{
#ifdef _IRR_COMPILE_WITH_X11_
...
video::IVideoModeList* CIrrDeviceX11::getVideoModeList()
{
#ifdef _IRR_COMPILE_WITH_X11_
...
//! Minimize window
void CIrrDeviceX11::minimizeWindow()
{
#ifdef _IRR_COMPILE_WITH_X11_
...
//! Maximize window
void CIrrDeviceX11::maximizeWindow()
{
#ifdef _IRR_COMPILE_WITH_X11_
	XMapWindow(display, window);
#endif
...
void CIrrDeviceX11::restoreWindow()
{
#ifdef _IRR_COMPILE_WITH_X11_
	XMapWindow(display, window);
#endif
...
void CIrrDeviceX11::createKeyMap()
{
...
bool CIrrDeviceX11::setGammaRamp( f32 red, f32 green, f32 blue, f32 brightness, f32 contrast )
{
	#if defined(_IRR_LINUX_X11_VIDMODE_) || defined(_IRR_LINUX_X11_RANDR_)
	s32 eventbase, errorbase;
	#ifdef _IRR_LINUX_X11_VIDMODE_
...
bool CIrrDeviceX11::getGammaRamp( f32 &red, f32 &green, f32 &blue, f32 &brightness, f32 &contrast )
{
	brightness = 0.f;
	contrast = 0.f;
	#if defined(_IRR_LINUX_X11_VIDMODE_) || defined(_IRR_LINUX_X11_RANDR_)
...
const c8* CIrrDeviceX11::getTextFromClipboard() const
{
#if defined(_IRR_COMPILE_WITH_X11_)
...
void CIrrDeviceX11::copyToClipboard(const c8* text) const
{
#if defined(_IRR_COMPILE_WITH_X11_)
...
void CIrrDeviceX11::clearSystemMessages()
{
#ifdef _IRR_COMPILE_WITH_X11_
	if (CreationParams.DriverType != video::EDT_NULL)
	{
...
Cursor CIrrDeviceX11::TextureToMonochromeCursor(irr::video::ITexture * tex, const core::rect<s32>& sourceRect, const core::position2d<s32> &hotspot)
{
...
#ifdef _IRR_LINUX_XCURSOR_
Cursor CIrrDeviceX11::TextureToARGBCursor(irr::video::ITexture * tex, const core::rect<s32>& sourceRect, const core::position2d<s32> &hotspot)
{
...
Cursor CIrrDeviceX11::TextureToCursor(irr::video::ITexture * tex, const core::rect<s32>& sourceRect, const core::position2d<s32> &hotspot)
{
#ifdef _IRR_LINUX_XCURSOR_
...
CIrrDeviceX11::CCursorControl::CCursorControl(CIrrDeviceX11* dev, bool null)
	: Device(dev)
#ifdef _IRR_COMPILE_WITH_X11_
...
CIrrDeviceX11::CCursorControl::~CCursorControl()
{
...
#ifdef _IRR_COMPILE_WITH_X11_
void CIrrDeviceX11::CCursorControl::clearCursors()
{
	if (!Null)
...
void CIrrDeviceX11::CCursorControl::initCursors()
{
...
void CIrrDeviceX11::CCursorControl::update()
{
...
void CIrrDeviceX11::CCursorControl::setActiveIcon(gui::ECURSOR_ICON iconId)
{
#ifdef _IRR_COMPILE_WITH_X11_
...
gui::ECURSOR_ICON CIrrDeviceX11::CCursorControl::addIcon(const gui::SCursorSprite& icon)
{
#ifdef _IRR_COMPILE_WITH_X11_
	if ( icon.SpriteId >= 0 )
	{
...
void CIrrDeviceX11::CCursorControl::changeIcon(gui::ECURSOR_ICON iconId, const gui::SCursorSprite& icon)
{
#ifdef _IRR_COMPILE_WITH_X11_
	if ( iconId >= (s32)Cursors.size() )
		return;
...
irr::core::dimension2di CIrrDeviceX11::CCursorControl::getSupportedIconSize() const
{
