...
#ifndef __C_IRR_DEVICE_X11_H_INCLUDED__
#define __C_IRR_DEVICE_X11_H_INCLUDED__
...
namespace irr
{
	class CIrrDeviceX11 : public CIrrDeviceLinux
	{
	public:

		//! constructor
		CIrrDeviceX11(const SIrrlichtCreationParameters& param);

		//! destructor
		virtual ~CIrrDeviceX11();
	...
	private:
		...
		public:
			...
			CCursorControl(CIrrDeviceX11* dev, bool null);
...
#endif // __C_IRR_DEVICE_X11_H_INCLUDED__
